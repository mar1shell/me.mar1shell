...
export default function NavBarLink({
  ...
  return (
    <a
      href={href}
      className={`group relative hidden items-center px-8 py-4 font-semibold text-gray-700 transition-colors duration-300 ease-out hover:text-blue-600 md:flex dark:text-gray-200 dark:hover:text-green-400 ${className} flex-nowrap`}
    >
