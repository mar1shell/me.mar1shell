...
export default function NavBar() {
  ...
  return (
    <nav
      className={`z-2000 ${showNav ? "translate-y-0" : "-translate-y-full"} ${isNavTop ? "py-2" : ""} fixed top-0 left-0 z-50 flex w-full justify-center bg-gray-200/10 shadow backdrop-blur-lg transition-all duration-300 dark:bg-gray-700/10`}
    >
